...
label splashscreen:
    ...
    if not persistent.first_run:
        ...
        with Dissolve(1.0)
        pause 1.0
        "This mod is fan content and is in no way affiliated with Team Salvato."
        "Individuals suffering from anxiety or depression may not have a safe experience playing this game."
        menu:
            "By playing this mod, you confirm that you have already played through the original game."
            "I agree.":
                pass
