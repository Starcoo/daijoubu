...
define audio.t2g = "bgm/2g.ogg" #distorted "Ohayou Sayori!"
define audio.t2g2 = "<from 4.499 loop 4.499>bgm/2.ogg"
define audio.t2g3 = "<loop 4.492>bgm/2g2.ogg" #"Ohayou Sayori!" that shifts a pitch upwards
define audio.t3 = "<loop 4.618>bgm/3.ogg"   #Main theme (in-game)
define audio.t3g = "<to 15.255>bgm/3g.ogg" #Main theme (in-game) with incorrect notes
define audio.t3g2 = "<from 15.255 loop 4.618>bgm/3.ogg"
define audio.t3g3 = "<loop 4.618>bgm/3g2.ogg" #Main theme (in-game) muffled with wet noises
define audio.t3m = "<loop 4.618>bgm/3.ogg"
define audio.t4 = "<loop 19.451>bgm/4.ogg"  #Poem minigame, "Dreams of Love and Literature"
define audio.t4g = "<loop 1.000>bgm/4g.ogg" #Static from glitch words in poem game
...
define audio.t5c = "<loop 4.444>bgm/5.ogg" #Same thing?
define audio.t6 = "<loop 10.893>bgm/6.ogg"  #Yuri/Natsuki theme, "Play With Me" 
define audio.t6g = "<loop 10.893>bgm/6g.ogg" #Distorted "Play With Me"
define audio.t6r = "<to 39.817 loop 0>bgm/6r.ogg" #Sped-up, reversed "Play With Me", for rewind
define audio.t6s = "<loop 43.572>bgm/6s.ogg" #4x slowed "Play With Me", from Yuri weekend
define audio.t7 = "<loop 2.291>bgm/7.ogg"   #Causing trouble, "Poem Panic!"
define audio.t7a = "<loop 4.316 to 12.453>bgm/7.ogg"
define audio.t7g = "<loop 31.880>bgm/7g.ogg" #"Poem Panic!" that speeds up
...
define audio.t10y = "<loop 0>bgm/10-yuri.ogg" #Creepy Yuri "My Confession"
define audio.td = "<loop 36.782>bgm/d.ogg" #"Sayo-nara


define audio.m1 = "<loop 0>bgm/m1.ogg" #Monika and her spaceroom music, "Just Monika."
define audio.mend = "<loop 6.424>bgm/monika-end.ogg" #Monika music post-deletion, "I Still Love You"

define audio.ghostmenu = "<loop 0>bgm/ghostmenu.ogg" #Creepy ambience, breathing?
define audio.g1 = "<loop 0>bgm/g1.ogg" #short static-y noise
define audio.g2 = "<loop 0>bgm/g2.ogg" #long, lower static-y noise
define audio.hb = "<loop 0>bgm/heartbeat.ogg" #heartbeat noise

define audio.closet_open = "sfx/closet-open.ogg" #opening closet
define audio.closet_close = "sfx/closet-close.ogg" #closing closet
define audio.page_turn = "sfx/pageflip.ogg" #flip of a page
define audio.fall = "sfx/fall.ogg" #falling down
